...
const CloseOrder = () => {
    ...
    const getYourOrders = () => {
        if (formData18.user && formData18.user.id) {
            ...
            fetch('https://shipsaver18-backend.onrender.com/DeliverySaverApi/rkGetYourOrders', {
                method: 'POST',
                headers: {
    ...
    const handleOrderClose = (orderId) => {
        ...
        fetch('https://shipsaver18-backend.onrender.com/DeliverySaverApi/rkCloseOrder', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
            },
